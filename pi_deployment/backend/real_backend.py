...
try:
    ...
    ollama_host = os.environ.get('OLLAMA_HOST', 'http://192.168.123.240:8034')
    ollama_model = os.environ.get('OLLAMA_MODEL', 'qwen2.5:7b-instruct-q8_0')
...
if __name__ == '__main__':
    ...
    print(f"💻 MAC Management: http://{host}:{port}")
    
    if ai_enabled:
        print(f"🤖 AI Assistant: http://{host}:{port}/ai-staging (mode: {ai_mode})")
